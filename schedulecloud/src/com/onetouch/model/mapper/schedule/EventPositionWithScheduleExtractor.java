	...
	public List<EventPosition> extractData(ResultSet rs) throws SQLException,
		...
		while(rs.next()){
			...
			if(eventPosition==null){
				...
				eventPosition.setOfferNotes(rs.getString("offer_notes"));
				eventPosition.setOfferCount(rs.getInt("offer_count"));
			...
			List<Employee> acceptedEmps = eventPosition.getPosition().getAcceptedEmps();
			if(acceptedEmps==null){
				acceptedEmps = new ArrayList<Employee>();
				eventPosition.getPosition().setAcceptedEmps(acceptedEmps);
			}
