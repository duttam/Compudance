...
public class DefaultScheduleEvent implements ScheduleEvent, Serializable {
	...
	public DefaultScheduleEvent(String title, Date start, Date end, Object data, String styleClass) {
		this.title = title;
		this.startDate = start;
		this.endDate = end;
		this.data = data;
	...
	public DefaultScheduleEvent(String title, Date start, Date end, Object data, boolean allDay) {
		this.title = title;
		this.startDate = start;
		this.endDate = end;
		this.data = data;
	...
	public DefaultScheduleEvent(String title, Date start, Date end, String styleClass, boolean allDay) {
		this.title = title;
		this.startDate = start;
		this.endDate = end;
		this.styleClass = styleClass;
